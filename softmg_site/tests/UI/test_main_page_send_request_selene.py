...
class TestSendRequests:
    ...
    def test_send_request_without_checkbox_in_header(self, driver_setup_all):
        page = MainPageSelene()
        page.open_page()
    ...
    def test_send_request_three_characters_in_header(
            self, driver_setup_all, name_field, input_data, text_error
    ):
        page = MainPageSelene()
        page.open_page()
    ...
    def test_send_request_at_sign_email_in_header(self, driver_setup_all):
    ...
    def test_send_requests_with_fill_form_in_header(self, driver_setup_all):
        page = MainPageSelene()
        page.open_page()
    ...
    # @pytest.mark.skip()
    # def test_send_required_fields_in_header(self, driver_setup_all):
    #     page = MainPageSelene()
    #     page.open_page()
    ...
    def test_send_requests_with_fill_form_in_footer(self, driver_setup_all):
