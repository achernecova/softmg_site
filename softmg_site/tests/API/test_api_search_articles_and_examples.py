...
from softmg_site.pages.articles_page import ArticlesPage
...
def test_api_search_examples_with_tag_meditsina(api_help):
...
def test_api_search_article_with_tag_testing(api_help):
